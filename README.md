...
2. Connect the Kappa3710Ard to the Arduino UNO.  
3. Connect a DMX controller to the Kappa3710Ard.

**All set!** Now, moving the slider for **DMX Channel 1** should change the **red** color of the RGB LED on the **Kappa3710Ard**. The same applies to **Channels 2 and 3**, which control the **green** and **blue** colors respectively.
